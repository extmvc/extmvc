...
Ext.ux.MVC.Router.prototype = {
  ...
  constructDefaultLinkToName: function(urlOptions, linkOptions) {
    ...
    var actionName = String.titleize(urlOptions.action);
    if (actionName == 'Index') {
      return "Show " + String.titleize(urlOptions.controller);
    } else {
      return actionName + " " + String.titleize(linkOptions.singularName);
    }
  },
