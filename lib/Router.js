...
Ext.ux.MVC.Router.prototype = {
  ...
  resources: function(resource_name, options) {
    ...
    this.name(indexName, resource_name,               {controller: resource_name, action: 'index'});
    this.name(newName,   resource_name + '/new',      {controller: resource_name, action: 'new'  });
    this.name(showName,  resource_name + '/:id',      {controller: resource_name, action: 'show', conditions: {':id': "[0-9]+"}});
    this.name(editName,  resource_name + '/:id/edit', {controller: resource_name, action: 'edit', conditions: {':id': "[0-9]+"}});
  },
