...
Ext.ux.MVC.Router.prototype = {
  ...
  resources: function(resource_name, options) {
    ...
    this.name(String.format("{0}_path",     resource_name.pluralize()),   resource_name,               {controller: resource_name, action: 'index'});
    this.name(String.format("new_{0}_path", resource_name.singularize()), resource_name + '/new',      {controller: resource_name, action: 'new'  });
    this.name(String.format("{0}_path",     resource_name.singularize()), resource_name + '/:id',      {controller: resource_name, action: 'show' });
    this.name(String.format("edit_{0}_path",resource_name.singularize()), resource_name + '/:id/edit', {controller: resource_name, action: 'edit' });
  },
