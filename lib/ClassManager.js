ExtMVC.ClassManager = Ext.extend(Ext.util.Observable, {
...
Ext.apply(ExtMVC, {
   ...
   * @return {ExtMVC.ClassManager} The class manager instance
   */
   ...
   * @param {ExtMVC.ClassManager} manager The ClassManager instance to register
   */
